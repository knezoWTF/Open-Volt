...
public final class ShieldBreakerOLD extends Module {
    ...
    public ShieldBreakerOLD() {
        super("Shield Breaker OLD", "old volt shield breaker", -1, Category.COMBAT);
        this.addSettings(
    ...
    private void onTickEvent(TickEvent event) {
        ...
        if (!slotTimer.hasElapsedTime(slotDelay.getValueInt() * 50L)) return;
        ...
        if (!hitDelayTimer.hasElapsedTime(hitDelay.getValueInt() * 50L)) return;
